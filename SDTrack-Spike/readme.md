...
For SDTrack-Tiny(Base)'s firing rate and energy consumption calculations, see [Energy_Consumption_Tiny.py](https://github.com/YmShan/SDTrack/blob/main/SDTrack-Spike/Energy_Consumption_Base.py)([Energy_Consumption_Base.py](https://github.com/YmShan/SDTrack/blob/main/SDTrack-Spike/Energy_Consumption_Base.py)).
