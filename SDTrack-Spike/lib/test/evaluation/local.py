...
def local_env_settings():
    ...
    settings.network_path = '/data1/users/shanym/SDTrack-Spike/output/test/networks'    # Where tracking networks are stored.
    settings.nfs_path = '/data/dataset/nfs'
    settings.otb_path = '/data/dataset/otb'
    settings.prj_dir = '/data1/users/shanym/SDTrack-Spike'
    settings.result_plot_path = '/data1/users/shanym/SDTrack-Spike/output/test/result_plots'
    settings.results_path = '/data1/users/shanym/SDTrack-Spike/output/test/tracking_results'    # Where to store tracking results
    settings.save_dir = '/data1/users/shanym/SDTrack-Spike/output'
    settings.segmentation_path = '/data1/users/shanym/SDTrack-Spike/output/test/segmentation_results'
