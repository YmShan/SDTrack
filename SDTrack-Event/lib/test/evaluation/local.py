...
def local_env_settings():
    ...
    settings.network_path = '/data/users/shanym/SDTrack-Event/output/test/networks'    # Where tracking networks are stored.
    settings.nfs_path = '/data/dataset/nfs'
    settings.otb_path = '/data/dataset/otb'
    settings.prj_dir = '/data/users/shanym/SDTrack-Event'
    settings.result_plot_path = '/data/users/shanym/SDTrack-Event/output/test/result_plots'
    settings.results_path = '/data/users/shanym/SDTrack-Event/output/test/tracking_results'    # Where to store tracking results
    settings.save_dir = '/data/users/shanym/SDTrack-Event/output'
    settings.segmentation_path = '/data/users/shanym/SDTrack-Event/output/test/segmentation_results'
